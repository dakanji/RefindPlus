...
[BuildOptions.IA32]
!if $(TARGET) == RELEASE
    XCODE:*_*_*_CC_FLAGS = -Os -DEFI32 -D__MAKEWITH_TIANO -DREFIT_DEBUG=0
    GCC:*_*_*_CC_FLAGS   = -Os -DEFI32 -D__MAKEWITH_TIANO -DREFIT_DEBUG=0
!endif
!if $(TARGET) == DEBUG
    XCODE:*_*_*_CC_FLAGS = -Os -DEFI32 -D__MAKEWITH_TIANO -DREFIT_DEBUG=1
    GCC:*_*_*_CC_FLAGS   = -Os -DEFI32 -D__MAKEWITH_TIANO -DREFIT_DEBUG=1
!endif
!if $(TARGET) == NOOPT
    XCODE:*_*_*_CC_FLAGS = -Os -DEFI32 -D__MAKEWITH_TIANO -DREFIT_DEBUG=2
    GCC:*_*_*_CC_FLAGS   = -Os -DEFI32 -D__MAKEWITH_TIANO -DREFIT_DEBUG=2
!endif


[BuildOptions.X64]
!if $(TARGET) == RELEASE
    XCODE:*_*_*_CC_FLAGS = -Os -DEFIX64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=0
    GCC:*_*_*_CC_FLAGS   = -Os -DEFIX64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=0
!endif
!if $(TARGET) == DEBUG
    XCODE:*_*_*_CC_FLAGS = -Os -DEFIX64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=1
    GCC:*_*_*_CC_FLAGS   = -Os -DEFIX64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=1
!endif
!if $(TARGET) == NOOPT
    XCODE:*_*_*_CC_FLAGS = -Os -DEFIX64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=2
    GCC:*_*_*_CC_FLAGS   = -Os -DEFIX64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=2
!endif


[BuildOptions.AARCH64]
!if $(TARGET) == RELEASE
    XCODE:*_*_*_CC_FLAGS = -Os -DEFIAARCH64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=0
    GCC:*_*_*_CC_FLAGS   = -Os -DEFIAARCH64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=0
!endif
!if $(TARGET) == DEBUG
    XCODE:*_*_*_CC_FLAGS = -Os -DEFIAARCH64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=1
    GCC:*_*_*_CC_FLAGS   = -Os -DEFIAARCH64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=1
!endif
!if $(TARGET) == NOOPT
    XCODE:*_*_*_CC_FLAGS = -Os -DEFIAARCH64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=2
    GCC:*_*_*_CC_FLAGS   = -Os -DEFIAARCH64 -D__MAKEWITH_TIANO -DREFIT_DEBUG=2
!endif
