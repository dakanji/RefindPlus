...
The popular build tool, Docker, can be used to build RefindPlus and an instance has been created by a third party developer at https://github.com/xaionaro/edk2-builder-docker. Please refer to that repository for details and support
